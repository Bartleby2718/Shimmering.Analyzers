...
public class ArrayOrArrayReturningMethodFollowedByToArrayCodeFixProviderTests : ShimmeringCodeFixProviderTests<ArrayOrArrayReturningMethodFollowedByToArrayAnalyzer, ArrayOrArrayReturningMethodFollowedByToArrayCodeFixProvider>
{
	...
	[Test]
	public Task TestToArrayChainedBySomethingElse() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Linq;
	...
	[Test]
	public Task TestTriviaWhenToArrayComesLastWithComments() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Linq;
	...
	[Test]
	public Task TestTriviaWhenToArrayComesLastWithoutComments() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Linq;
	...
	[Test]
	public Task TestTriviaWhenToArrayIsFollowedBySomethingElse() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Linq;
