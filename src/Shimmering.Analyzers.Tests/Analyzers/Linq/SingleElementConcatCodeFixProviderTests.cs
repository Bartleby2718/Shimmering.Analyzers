...
public class SingleElementConcatCodeFixProviderTests : ShimmeringCodeFixProviderTests<SingleElementConcatAnalyzer, SingleElementConcatCodeFixProvider>
{
	...
	[Test]
	public Task TestCollectionExpression() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Collections.Generic;
		using System.Linq;
	...
	[Test]
	public Task TestCastExpressionContainingCollectionExpression() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Collections.Generic;
		using System.Linq;
	...
	[Test]
	public Task TestTestCollectionInitializerWithArray() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Collections.Generic;
		using System.Linq;
	...
	[Test]
	public Task TestCollectionInitializerWithList() => VerifyCodeFixAsync(
		"""
		using System;
		using System.Collections.Generic;
		using System.Linq;
